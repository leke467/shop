...
PLANS = [
    {
        ...
        "max_shops": 1,
        "max_products": 5,
        "custom_shop_template_enabled": False,
        "custom_shop_theme_enabled": False,
    ...
    },
    {
        ...
        "monthly_price": Decimal("3500"),
        "max_shops": 2,
        "max_products": 50,
        "custom_shop_template_enabled": False,
        "custom_shop_theme_enabled": True,
        "custom_domain_enabled": False,
        "analytics_enabled": False,
        "priority_support_enabled": False,
        "is_enterprise": False,
    ...
    },
    {
        "code": "growth",
        "name": "Growth",
        "description": "Scale up with a custom domain, custom theme, and analytics.",
        "monthly_price": Decimal("7500"),
        "max_shops": 5,
        "max_products": 200,
        "custom_shop_template_enabled": True,
        "custom_shop_theme_enabled": True,
    ...
    },
    {
        "code": "business",
        "name": "Business",
        "description": "Unlimited shops, 20+ templates, custom theme & domain, advanced analytics, and priority support.",
