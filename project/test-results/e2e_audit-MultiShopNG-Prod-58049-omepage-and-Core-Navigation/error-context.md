...
- Name: e2e_audit.spec.js >> MultiShopNG Production Playwright Autonomous Audit >> 1. Audit Homepage and Core Navigation
- Location: e2e_audit.spec.js:6:3
...
Locator: locator('a:has-text("Explore")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Explore")').first()
