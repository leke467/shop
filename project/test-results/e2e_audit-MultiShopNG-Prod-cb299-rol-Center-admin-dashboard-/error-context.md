...
- Name: e2e_audit.spec.js >> MultiShopNG Production Playwright Autonomous Audit >> 3. Audit Superadmin Control Center (/admin/dashboard)
- Location: e2e_audit.spec.js:33:3
...
Locator: locator('text=MultiShopNG').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=MultiShopNG').first()
