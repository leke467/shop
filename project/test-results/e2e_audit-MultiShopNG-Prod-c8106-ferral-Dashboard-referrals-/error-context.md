...
- Name: e2e_audit.spec.js >> MultiShopNG Production Playwright Autonomous Audit >> 2. Audit Referral Dashboard (/referrals)
- Location: e2e_audit.spec.js:14:3
...
Locator: locator('text=Refer & Earn Program')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Refer & Earn Program')
