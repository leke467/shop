    ...
    case 'farmfresh':
      return (
        <div className="w-full h-full bg-[#F8FAFC] p-2.5 flex flex-col justify-between select-none overflow-hidden relative font-sans text-slate-900">
          {/* Green Bar */}
          <div className="flex justify-between items-center bg-[#064E3B] text-white px-2 py-1 rounded text-[8px] font-bold">
            <span className="flex items-center gap-1">❄️ FARMFRESH HUB</span>
            <span className="text-[7px] text-emerald-300">SUB-ZERO</span>
          </div>
          {/* Banner */}
          <div className="bg-gradient-to-r from-[#064E3B] to-[#0B4F37] text-white p-2 rounded-lg flex items-center justify-between">
            <div className="space-y-0.5">
              <div className="text-[8px] font-extrabold text-emerald-300">LIVE & FLASH FROZEN</div>
          ...
          {/* Agro Product Cards */}
          <div className="grid grid-cols-3 gap-1">
            <div className="bg-white border border-slate-200 rounded p-1 flex flex-col items-center shadow-2xs">
              <div className="w-full h-6 bg-sky-50 rounded flex items-center justify-center text-[10px]">❄️</div>
              <div className="w-6 h-1 bg-slate-400 rounded mt-1"></div>
              <div className="w-4 h-1 bg-emerald-600 rounded mt-0.5"></div>
            </div>
            <div className="bg-white border border-slate-200 rounded p-1 flex flex-col items-center shadow-2xs">
